...
const USAGE = `Usage:
  ...
  ide-hub session migrate --source codex --target <qoder-international|qoder-cn|cursor|deepseek-harness|zcode|pi|claude-code|codebuddy-international|codebuddy-cn> --thread <thread-id> [--dry-run]
